...
namespace DL.Entity
{
    [MetadataType(typeof(RoomTypeMD))]
    public partial class RoomType
    {
        #region --- Property Declaration ---
        public class RoomTypeMD
        {
        ...
        public LookupModel GetById(Guid id)
        {
            try
            {
                ...
                using (var db = new HMSEntities())
                {
                    RoomType entity = db.RoomTypes.Find(id);
                    if (entity != null)
                    {
                        model.Id = entity.Id;
        ...
        public LookupModel GetByName(string name)
        {
            try
            {
                ...
                using (var db = new HMSEntities())
                {
                    RoomType entity = db.RoomTypes.FirstOrDefault(t => t.Name == name);
                    if (entity != null)
                    {
                        model.Id = entity.Id;
                        model.Name = entity.Name;
        ...
        public bool Update(LookupModel model)
        {
            try
            {
                ...
                if (!IsExist(model))
                {
                    using (var db = new HMSEntities())
                    {
                        RoomType entity = db.RoomTypes.Find(model.Id);
