...
namespace HospitalManagement.Forms.Lookup
{
    public partial class RoomTypeList : Form
    {
        ...
        public RoomTypeList()
        {
            ...
            {
                Utility.ErrorLog.Logging("RoomType List", ex.Message.ToString(), ex.StackTrace.ToString());
            }
        }
        ...
        private void Search(string searchText = "")
        {
            try
            {
                List<LookupModel> list = service.AdvanceSearch(LookUp.RoomType, searchText);
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            try
            {
                RoomTypeOperations frm = new RoomTypeOperations();
                frm.ShowDialog();
        ...
        private void FillFormData(Guid? id)
        {
            try
            {
                LookupModel model = service.GetById(LookUp.RoomType, id.Value);
                if (model != null)
                {
                    Lookup.RoomTypeOperations frm = new Lookup.RoomTypeOperations(model.Id);
