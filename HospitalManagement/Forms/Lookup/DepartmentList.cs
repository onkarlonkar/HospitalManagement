...
namespace HospitalManagement.Forms.Lookup
{
    public partial class DepartmentList : Form
    {
        ...
        public DepartmentList()
        {
            ...
            {
                Utility.ErrorLog.Logging("Department List", ex.Message.ToString(), ex.StackTrace.ToString());
            }
        }
        ...
        private void Search(string searchText = "")
        {
            try
            {
                List<LookupModel> list = service.AdvanceSearch(LookUp.Department, searchText);
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            try
            {
                DepartmentOperations frm = new DepartmentOperations();
                frm.ShowDialog();
        ...
        private void FillFormData(Guid? id)
        {
            try
            {
                LookupModel model = service.GetById(LookUp.Department, id.Value);
                if (model != null)
                {
                    Lookup.DepartmentOperations frm = new Lookup.DepartmentOperations(model.Id);
